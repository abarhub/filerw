...
public class TestLineContentBinary {
	...
	public void test() {
		...
		assertTrue(Tools.equals(new byte[]{1,2,3,4},line.get(FieldsListChamps2.Code1)));
		assertTrue(Tools.equals(new byte[]{5,6,7,8,9,10},line.get(FieldsListChamps2.Code2)));
		assertTrue(Tools.equals(new byte[]{11,12,13,14,15,16,17},line.get(FieldsListChamps2.Code3)));
	}
	...
	public void test2() {
		...
		assertTrue(Tools.equals(new byte[]{31,32,33,34},line.get(FieldsListChamps2.Code1)));
		assertTrue(Tools.equals(new byte[]{100,101,102,103,104,105},line.get(FieldsListChamps2.Code2)));
		assertTrue(Tools.equals(new byte[]{41,42,43,44,45,46,47},line.get(FieldsListChamps2.Code3)));
	...
	public void test3()
	{
		...
		assertTrue(Tools.equals(new byte[]{0,0,0,0},line.get(FieldsListChamps2.Code1)));
		assertTrue(Tools.equals(new byte[]{0,0,0,0,0,0},line.get(FieldsListChamps2.Code2)));
		assertTrue(Tools.equals(new byte[]{0,0,0,0,0,0,0},line.get(FieldsListChamps2.Code3)));
	...
	public void test6() {
		...
		assertTrue(Tools.equals(new byte[]{56,63,-41,25},line.get(FieldsListChamps2.Code1)));
		assertTrue(Tools.equals(new byte[]{35,36,92,38,39,40},line.get(FieldsListChamps2.Code2)));
		assertTrue(Tools.equals(new byte[]{41,42,43,44,45,46,47},line.get(FieldsListChamps2.Code3)));
		...
		assertTrue(Tools.equals(new byte[]{56,63,-41,25},line.get(FieldsListChamps2.Code1)));
		assertTrue(Tools.equals(new byte[]{21,44,0,0,0,0},line.get(FieldsListChamps2.Code2)));
		assertTrue(Tools.equals(new byte[]{41,42,43,44,45,46,47},line.get(FieldsListChamps2.Code3)));
